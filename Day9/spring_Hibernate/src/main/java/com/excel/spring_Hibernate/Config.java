...
@Configuration
@ComponentScan(basePackages = "com.excel.spring_Hibernate")
...
public DataSource getSource() {
	...
	ds.setUrl("jdbc:mysql://localhost:3306/student_1");
	ds.setUsername("root");
...
public LocalSessionFactoryBean sessionFactory() 
{
	...
	sessionFactory.setPackagesToScan("com.excel.spring_Hibernate");
